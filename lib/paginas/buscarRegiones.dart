...
class BuscarRegiones extends SearchDelegate{

  final List RegionesLista;

  BuscarRegiones(this.RegionesLista);
  ...
  Widget buildSuggestions(BuildContext context)
  {
    ...
    query.isEmpty?
    RegionesLista:
    RegionesLista.where((element) => element['titulo'].toString().toLowerCase().startsWith(query)).toList();
